...
//         <Link
//           href="/dashboard/new"
//           className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold text-white transition-all hover:opacity-90 w-full sm:w-auto justify-center sm:justify-start"
//           style={{ background: "var(--color-accent)" }}
//         >
//           <Plus size={16} />
//           New Page
...
//       {!pages || pages.length === 0 ? (
//         <div
//           className="rounded-2xl border border-dashed p-8 sm:p-12 lg:p-16 text-center"
//           style={{ borderColor: "var(--color-border)" }}
//         >
//           <div
...
//             style={{ background: "var(--color-surface-2)" }}
//           >
//             <Plus size={22} style={{ color: "var(--color-muted)" }} />
//           </div>
//           <p
